...
export default function Detail() {
  ...
  return (
    <>
      ...
      <div className=" relative border-0 w-full flex" style={{height : "1800px"}}>
  ...
  transition duration-150 ease-in-out origin-top min-w-32"
        ...
        <div className="">
      <div className="absolute border-0  bottom-0 left-14 " style={{width : "92%"}}>
        <div className="flex border-b pb-2 font-semibold border-gray-300 w-full gap-28">
          <button>
          <p className="text-red-500">Detail Perjalanan</p>
          </button>
          <button>
          <p className="hover:text-red-500 text-gray-500">Syarat & Ketentuan</p>
          </button>
          <button>
          <p className="hover:text-red-500 text-gray-500">Galeri</p>
          </button>
          <button>
          <p className="hover:text-red-500 text-gray-500">Ulasan</p>
          </button>
        </div>
        <div className="mt-16">
          <div className="">
            <div className="flex gap-14">
            <div className="text-white font-semibold text-center justify-center border-0 py-4 w-20 bg-red-500 ">
            <p className="">Hari</p>
            <p className="">1</p>
            </div>
        ...
        <div className="mt-16">
          <div className="">
            <div className="flex gap-14">
            <div className="text-white font-semibold text-center  border-0 h-20 w-20 bg-red-500 ">
            ...
            <div className="font-semibold text-gray-800">
              <div className="flex gap-5">
              <p>12.00</p>
              <p>Makan Siang di Lokal Restorant (Biaya Pribadi) di meeting point</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>13.00</p>
              <p>Perjalanan menuju homestay</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>13.45</p>
              <p>Tiba di Homestay untuk beristirahat & Free time (Waktu Bebas)</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>22.00</p>
              <p>Persiapan perjalanan menuju Bromo</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>22.30</p>
              <p>Perjalanan menuju bromo untuk melihat sunrise</p>
              </div>
            </div>
            </div>
          </div>
        ...
        <div className="mt-16">
          <div className="">
            <div className="flex gap-14">
            <div className="text-white font-semibold text-center  border-0 h-20 w-40 bg-red-500 ">
              <div className="justify-center my-4">
            <p className="">Hari</p>
            <p className="">3</p>
              </div>
            ...
            <div className="font-semibold text-gray-800">
              ...
              <div className="flex mt-3 gap-5">
              <p>13.00</p>
              <p>City Tour dan Sight Seeing Kota Batu</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>15.00</p>
              <p>Perjalanan menuju tempat oleh-oleh</p>
              </div>
              <div className="flex mt-3 gap-5">
              <p>17.00</p>
              <p>Perjalanan kembali ke Jakarta</p>
              </div>
            </div>
            </div>
          </div>
